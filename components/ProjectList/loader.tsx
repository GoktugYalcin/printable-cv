        ...
        <div className="flex flex-wrap flex-col justify-center items-start my-16 w-2/4">
            ...
            <div>
                {[1,2,3,4].map((item, index) => {
                    return <div className="flex justify-start items-start flex-col gap-1 mb-6" key={index}>
                        <span className="font-semibold">
                            <div className="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 w-48 mb-1"></div>
                        </span>
                        <span><div className="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 w-[550px] mb-1"></div></span>
